...
exports.InitBaseTable1743062434450 = void 0;
class InitBaseTable1743062434450 {
    constructor() {
        this.name = 'InitBaseTable1743062434450';
    }
    async up(queryRunner) {
        ...
        await queryRunner.query(`CREATE TABLE "banner" ("updated_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "deleted_at" TIMESTAMP WITH TIME ZONE, "created_by" integer, "updated_by" integer, "id" SERIAL NOT NULL, "image_url" character varying NOT NULL, "title" character varying NOT NULL, "subtitle" character varying NOT NULL, "order" integer NOT NULL, "is_active" boolean NOT NULL, "type" integer NOT NULL, "spa_info_id" integer NOT NULL, CONSTRAINT "PK_6d9e2570b3d85ba37b681cd4256" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "working_hour" ("updated_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "deleted_at" TIMESTAMP WITH TIME ZONE, "created_by" integer, "updated_by" integer, "id" SERIAL NOT NULL, "day_of_week" character varying NOT NULL, "opening_time" character varying NOT NULL, "closing_time" character varying NOT NULL, "is_closed" boolean NOT NULL DEFAULT false, "spa_info_id" integer NOT NULL, CONSTRAINT "PK_227995aef58f0f198f79ad42203" PRIMARY KEY ("id"))`);
...
exports.InitBaseTable1743062434450 = InitBaseTable1743062434450;
//# sourceMappingURL=1743062434450-InitBaseTable.js.map